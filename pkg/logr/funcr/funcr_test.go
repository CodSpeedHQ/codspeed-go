...
func TestInfoWithCaller(t *testing.T) {
	...
	t.Run("KV: LogCaller=All, LogCallerFunc=true", func(t *testing.T) {
		thisFunc := "github.com/CodSpeedHQ/codspeed-go/pkg/logr/funcr.TestInfoWithCaller.func3"
		capt := &capture{}
	...
	t.Run("JSON: LogCaller=All, LogCallerFunc=true", func(t *testing.T) {
		thisFunc := "github.com/CodSpeedHQ/codspeed-go/pkg/logr/funcr.TestInfoWithCaller.func4"
		capt := &capture{}
