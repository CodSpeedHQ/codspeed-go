// External test package (black-box testing) without benchmarks
...
// TestFibonacciIntegration is an integration test without benchmarks
// This ensures we handle external test packages correctly even when they don't have benchmarks
